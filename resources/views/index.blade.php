      ...
      <div class="col-lg-12">
        <div class="card shadow">
          <div class="card-header bg-danger d-flex justify-content-between align-items-center">
            <h3 class="text-light">Manage Employees
                <select class="form-select-sm sort_order" aria-label=".form-select-sm example" id="order_by_employ" >
                    <option value="">Short By</option>
                    <option value="1">Short By Name(ASC)</option>
                    <option value="2">Short By Name(DESC)</option>
                    <option value="3">Short By ID(ASC)</option>
                    <option value="4">Short By ID(DESC)</option>
                  </select>
            </h3>
  ...
  <script>
    $(function() {
      ...
      $(".sort_order").change(function(){
        var shorting = $('.sort_order').find(":selected").val();
        $.ajax({
          url: '{{ route('fetchAll') }}',
          method: 'get',
          success: function(response) {
